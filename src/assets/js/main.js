...
//  });
 ...
 $(document).ready(function(){
   $('.toggle2').click(function(){
     $('.sidebar-speaker').toggleClass('active')
     $('.toggle').toggleClass('active')
     $('body').toggleClass('sidebar-open')
   });
 
   $(document).click(function(event){
     if (!$(event.target).closest('.sidebar-speaker, .toggle2').length) {
       $('.sidebar-speaker').removeClass('active');
...
$(document).ready(function(){
  ...
  $(document).click(function(event){
    if (!$(event.target).closest('.sidebar-contact, .toggle').length) {
